...
@Component({
    selector: 'third-party-customer-cmp',
    templateUrl: 'third_party_customer.component.html'
})

export class ThirdPartyCustomerComponent implements OnInit, AfterViewInit, OnChanges {
    readURL(input: any) {
